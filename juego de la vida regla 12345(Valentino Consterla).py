    ...
    for y in range(0, nxC):
        for x in range(0, nyC):
            ...
            if not pauseExect:
                ...
                #Regla 2: si una celula viva tiene 1,2,3,4 o 5 vecinos este sobrevive.
                elif gameState[x, y] == 1 and (n_neigh == 1 or n_neigh == 2 or n_neigh == 3 or n_neigh == 4 or n_neigh == 5):
                    newGameState[x, y] = 1
